...
*Ce document présente mon portfolio de travaux, accessible sur GitHub, qui démontre mes compétences et mon expérience pertinentes pour différentes missions pour des entreprises de différents secteurs (industrie, informatique, santé, distribution, télécommunications, etc.) . J'ai eu l'opportunité de travailler sur de nombreux projets pour divers clients, ce qui m'a permis d'acquérir une expérience approfondie. Cependant, la nature sensible de la plupart de ces projets et les accords de confidentialité associés m'empêchent de les partager en public. Par conséquent, mon portfolio GitHub se concentre sur quelques projets qui illustrent au mieux mes capacités en analyse et visualisation de données. je pourrais en ajouter d'autres si possible*
